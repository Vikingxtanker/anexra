...
>
        ...
        <div className="flex-1 overflow-hidden rounded-xl border border-[#d8c7c9] bg-[#f4efee] p-3">
          <div className="h-full w-full flex items-center justify-center overflow-hidden rounded-lg border border-[#d8c7c9] bg-white">
            {previewObjectUrl ? (
